...
Este es el caso en el que ejecutamos el cuerpo de cualquier bloque como el cuerpo de una función, el cuerpo de un bucle o asignacion if … Todo aquello que esté limitado por llaves {Cuerpo del bloque}. Llamamos a ejecutar la cuerpo de forma que creamos a su vez una nueva lista de variables para englobar las variables pertenecientes a ese ámbito.
