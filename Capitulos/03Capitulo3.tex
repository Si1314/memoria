...
\lstinputlisting[caption=Uso espec\'ifico., style=customxml, firstline=112, lastline=112]{Codigos/xmlsCap2.xml}

Donde se puede simular con valores espec\'ificos en las variables Inf, Sup y MaxDepth.

\lstinputlisting[caption=Uso gen\'erico., style=customxml, firstline=113, lastline=113]{Codigos/xmlsCap2.xml}
