...
En este cap\'itulo analizaremos en profundidad la herramienta construida para realizar el primer paso hacia una ejecuci\'on simb\'olica de un programa por nuestro proyecto. Discutiremos las decisiones de diseño y los m\'etodos empleados para organizar los datos de una manera intuitiva y c\'omoda de manipular en la siguiente etapa del proceso. 
...
En la mayor\'ia de los casos CLANG ejecutar\'a el preprocesado y parsear\'a el c\'odigo formando un \'arbol de sint\'axis abstracta (de ahora en adelante: AST). Esta estructura de \'arbol es m\'as manejable que el propio c\'odigo con el añadido de que cualquier subestructura mantiene referencias al c\'odigo fuente.
...
Las instrucciones que producen ramificaciones en la ejecuci\'on de un programa, tales como: el if, el while o el for. Para poder realizar su ejecuci\'on correctamente mantenemos en sus respectivos nodos sus señas m\'as caracter\'isticas.
