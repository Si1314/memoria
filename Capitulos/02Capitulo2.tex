...
La disposici\'on b\'asica de un nodo function se puede observar en la figura 2.2.
...
La disposici\'on b\'asica de un nodo return se puede observar en la figura 2.3.
...
La disposici\'on b\'asica de un nodo declaration se puede observar en la figura 2.4.
...
La disposici\'on b\'asica de un nodo IF se puede observar en la figura 2.5.
...
La disposici\'on b\'asica de un nodo WHILE se puede observar en la figura 2.6.
...
La disposici\'on b\'asica de un nodo FOR se puede observar en la figura 2.7.
...
La disposici\'on b\'asica de un operador binario se puede observar en la figura 2.8.
...
La disposici\'on b\'asica de un operador de asignaci\'on se puede observar en la figura 2.9.
...
La disposici\'on b\'asica de un nodo con una asignaci\'on a otra variable se puede observar en la figura 2.10.
...
La disposici\'on b\'asica de un nodo con una asignaci\'on a un valor se puede observar en la figura 2.11.
...
La disposici\'on b\'asica de un nodo con un valor string se puede observar en la figura 2.12.
...
La disposici\'on b\'asica de un nodo con la llamada a una funci\'on se puede observar en la figura 2.13.
...
La figura 2.14 muestra las funciones incluidas por las bibliotecas.
